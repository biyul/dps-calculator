  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-4 rounded-full bg-background shadow-lg ring-0 transition-transform data-[unchecked]:translate-x-0.5 data-[checked]:translate-x-4 dark:data-[unchecked]:bg-foreground dark:data-[checked]:bg-primary-foreground"
      />
    </SwitchPrimitive.Root>
  )
}
